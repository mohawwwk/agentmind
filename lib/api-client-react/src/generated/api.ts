 ...
 */
export const agentChat = async (agentChatInput: AgentChatInput, options?: RequestInit): Promise<ChatResult> => {
    const formData = new FormData();
formData.append(`message`, agentChatInput.message);
if(agentChatInput.conversationId !== undefined && agentChatInput.conversationId !== null) {
 formData.append(`conversationId`, agentChatInput.conversationId);
 }

  return customFetch<ChatResult>(getAgentChatUrl(),
  {
    ...options,
    method: 'POST'
    ,
...
export const getAgentChatMutationOptions = <TError = ErrorType<ErrorResponse>,
 ...
 * @summary Submit a multi-modal query to the agent
 */
export const useAgentChat = <TError = ErrorType<ErrorResponse>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof agentChat>>, TError,{data: BodyType<AgentChatInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
